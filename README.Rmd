...
```{r timeline with label, echo = FALSE}
timeline_plot <- timeline(clean_df, y = Country, minyear = 2010, maxyear = 2015, countries = c('PALESTINE', 'EGYPT'),
                          label = TRUE, nmax = 10)
plot(timeline_plot)
```
